    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8 px-6 text-sm">
      <div className="max-w-6xl mx-auto text-center space-y-3">
        ...
        <p className="text-gray-300 text-sm font-medium">
          वेबसाइट या मोबाइल ऐप बनवाने के लिए संपर्क करें —{" "}
          <a href="https://www.nishantsoftwares.in" target="_blank" rel="noopener noreferrer" className="text-amber-400 hover:underline font-bold">
            www.nishantsoftwares.in
          </a>
        </p>
