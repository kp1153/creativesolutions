  ...
  return (
    <nav className="bg-white border-b border-gray-200 backdrop-blur-sm bg-white/95">
      <div className="max-w-7xl mx-auto px-4">
        {/* टॉप बार - फोन और ईमेल (आपका पुराना कोड जस का तस) */}
        <div className="py-2 border-b border-gray-100 flex items-center justify-between text-xs md:text-sm text-gray-600">
          ...
          {/* आपका पुराना WhatsApp लिंक - जैसा भी हो, वैसा ही रहेगा */}
          <a
        ...
        {/* लोगो सेक्शन (बिल्कुल आपका पुराना कोड) */}
        ...
        {/* नेविगेशन लिंक्स - यहाँ सिर्फ Invoice Generator वाला लिंक अलग रेंडर होगा */}
        <div className={`${isOpen ? "block" : "hidden"} md:block border-t border-gray-200`}>
          <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-3 md:gap-6 py-3 text-sm md:text-base text-gray-700">
            {navLinks.map((link) => {
              // सिर्फ Invoice Generator वाले लिंक के लिए अलग रेंडरिंग
              if (link.external) {
                return (
                  <a
                    key={link.href}
              ...
              // बाकी सभी लिंक आपके पुराने तरीके से
              return (
                <Link
                  key={link.href}
                  href={link.href}
