      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            ...
            बनवाना चाह रहे हैं तो आप सही जगह आ चुके हैं।
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-indigo-200">
          <p className="text-base md:text-lg text-gray-700 leading-relaxed text-center">
            हम जमाने-बाजार और जिंदगी की गहरी समझ से युक्त हैं और इस समझ को
            व्यक्त करने के लिए हमारे पास जरूरी भाषाई क्षमता भी है। गाँव के हैं
            तो बिंबों में भी चीजों को प्रस्तुत कर सकते हैं, लॉजिक-साइंस तो खैर
            है ही। अमूर्तन में जाना तो कोई हमसे सीखे।
            <span className="font-bold text-indigo-700">
              {" "}
              आइए मिलकर कुछ अलग बनाते हैं!
            </span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {offerings.map((offer, index) => (
            ...
            >
              <div
                className={`w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br ${offer.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
              >
        ...
        <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border-2 border-indigo-200">
          ...
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl p-6 text-white text-center">
            <p className="text-base md:text-lg leading-relaxed">
              <strong className="text-xl">⚡ Quick Response Guaranteed:</strong>
              <br />
              आपके message का reply 24 hours में मिल जाएगा। Website development
              से लेकर content creation तक - सब कुछ professional quality के साथ।
            </p>
          </div>
        </div>
      </div>
