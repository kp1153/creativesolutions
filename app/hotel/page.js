...
export default function HotelPage() {
  ...
  const pay = async () => {
    const res = await fetch("/api/razorpay/create-order", {
      ...
      body: JSON.stringify({ amount: 4999, plan: "new", software: "hotel" }),
    });
    ...
    <main className="min-h-screen bg-gray-950 text-white font-sans flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 py-16 bg-gradient-to-b from-gray-900 to-gray-950">
        ...
        <p className="text-gray-400 max-w-xl mb-6 text-base leading-relaxed">
          कमरे की बुकिंग से लेकर चेक-आउट तक, बिलिंग से लेकर कर्मचारी प्रबंधन तक — सब कुछ एक जगह। हिंदी में, बिना इंटरनेट के भी, और जीएसटी के साथ।
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href={HOTEL_EXE_URL} className="inline-block bg-pink-600 hover:bg-pink-500 text-white font-bold text-lg px-8 py-3 rounded-2xl shadow-lg transition">
            🖥️ Windows पर Download करें (.exe)
          </a>
          <div className="flex flex-col items-center">
            <a href={HOTEL_PWA_URL} target="_blank" rel="noopener noreferrer" className="inline-block bg-green-600 hover:bg-green-500 text-white font-bold text-lg px-8 py-3 rounded-2xl shadow-lg transition">
      ...
      <section className="px-4 py-8 bg-gray-900 border-y border-gray-800">
        <div className="max-w-3xl mx-auto bg-amber-950/40 border border-amber-600/30 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-4">विंडोज़ में <strong className="text-white">स्मार्ट ऐप कंट्रोल</strong> नाम की एक सुरक्षा है जो नए सॉफ्टवेयर को रोकती है। यह सॉफ्टवेयर पूरी तरह सुरक्षित है — बस नीचे दिए तरीके से इंस्टॉल करें।</p>
      ...
      <section className="px-4 py-8 bg-gray-950 border-b border-gray-800">
        <div className="max-w-3xl mx-auto bg-blue-950/30 border border-blue-600/20 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-4">Windows 11 has a security feature called <strong className="text-white">Smart App Control</strong> that may block newly downloaded software. This software is completely safe. Follow these steps if you see a warning:</p>
          <ol className="text-gray-300 text-sm leading-loose list-none space-y-1">
      ...
      <section className="px-4 py-14 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { title: "१. पहली बार सेटअप", items: ["• सॉफ्टवेयर खोलने पर सबसे पहले होटल का नाम, पता और फ़ोन नंबर डालें।", "• जीएसटी नंबर है तो वह भी डालें — रसीद पर अपने आप आएगा।", "• कमरों की संख्या और प्रकार (सिंगल, डबल, सुइट) सेट करें।", "• हर कमरे का किराया अलग-अलग डालें।"] },
              { title: "२. कमरा बुकिंग और चेक-इन", items: ["• नई बुकिंग — मेनू में 'बुकिंग' पर जाएं, मेहमान का नाम, फ़ोन, आने की तारीख और कमरा चुनें।", "• अग्रिम बुकिंग — भविष्य की तारीख चुनकर पहले से बुक करें।", "• चेक-इन — मेहमान आने पर उनकी बुकिंग खोलें और 'चेक-इन करें' दबाएं।", "• आधार/पहचान पत्र का फ़ोटो भी जोड़ सकते हैं।"] },
              { title: "३. चेक-आउट और बिलिंग", items: ["• मेहमान के कमरे पर जाएं और 'चेक-आउट' दबाएं।", "• कमरे का किराया, रेस्टोरेंट के बिल अपने आप जुड़ जाएंगे।", "• जीएसटी अपने आप जुड़ेगा।", "• रसीद प्रिंटर से या PDF बनाकर व्हाट्सऐप पर भेजें।", "• नकद, UPI, कार्ड — जो भुगतान आए वह दर्ज करें।"] },
              { title: "४. रेस्टोरेंट बिलिंग", items: ["• 'रेस्टोरेंट' मेनू में जाएं और नया ऑर्डर बनाएं।", "• ऑर्डर किसी कमरे से जोड़ सकते हैं — चेक-आउट पर बिल में मिल जाएगा।", "• बाहरी ग्राहक के लिए अलग बिल बना सकते हैं।"] },
              { title: "५. कर्मचारी प्रबंधन", items: ["• 'कर्मचारी' मेनू में नाम, पद और वेतन दर्ज करें।", "• रोज़ की हाज़िरी लगाएं — महीने के अंत में वेतन अपने आप निकलेगा।", "• हाउसकीपिंग को कमरे असाइन करें।"] },
              { title: "६. रिपोर्ट और आंकड़े", items: ["• आज की रिपोर्ट — कितने कमरे भरे हैं, कितनी कमाई हुई।", "• महीने की रिपोर्ट — पूरे महीने का हिसाब एक जगह।", "• सभी रिपोर्ट PDF में डाउनलोड कर सकते हैं।"] },
              { title: "७. डेटा बैकअप", items: ["• सेटिंग में 'बैकअप लें' दबाएं — एक फ़ाइल बन जाएगी।", "• पेनड्राइव या Google Drive में सुरक्षित रखें।", "• कंप्यूटर बदलने पर 'बैकअप से पुनः स्थापित करें' से डेटा वापस आएगा।", "• हर हफ्ते बैकअप लेने की आदत बनाएं।"] },
            ].map((sec, i) => (
              <div key={i} className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
                <h3 className="font-extrabold text-pink-400 text-lg mb-3">{sec.title}</h3>
      ...
      <section className="px-4 py-14 bg-gray-900 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href={HOTEL_EXE_URL} className="bg-pink-600 hover:bg-pink-500 text-white font-bold px-8 py-3 rounded-2xl text-base transition">
            {"⬇️ डाउनलोड करें — विंडोज़"}
          </a>
          <button onClick={pay} className="bg-pink-600 hover:bg-pink-500 text-white font-bold px-8 py-3 rounded-2xl text-base transition">
            {"💳 अभी खरीदें — ₹4,999"}
          </button>
          <a href="https://wa.me/919996865069" target="_blank" rel="noopener noreferrer" className="bg-green-700 hover:bg-green-600 text-white font-bold px-8 py-3 rounded-2xl text-base transition">
