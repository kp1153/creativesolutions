...
const features = [
  ...
  { icon: "🧾", title: "GST बिल", desc: "वजन डालो, टंच चुनो, मेकिंग चार्ज जोड़ो — हॉलमार्क/HUID सहित GST बिल तैयार।" },
  { icon: "♻️", title: "पुराना खरीदा", desc: "ग्राहक से पुराना सोना/चाँदी खरीदो — आधार/पैन सहित पूरा रिकॉर्ड।" },
  { icon: "🔁", title: "पुराना देकर नया", desc: "ग्राहक पुराना सोना देकर नया गहना ले — बिल में अपने आप घट जाएगा।" },
  { icon: "📦", title: "स्टॉक + बारकोड", desc: "हर गहने का बारकोड बने और छपे — स्कैन करते ही बिल बन जाए।" },
  { icon: "📊", title: "बिक्री रिपोर्ट", desc: "आज, हफ्ते, महीने की पूरी बिक्री — सोना/चाँदी, नकद/UPI/उधार अलग।" },
...
const manualSteps = [
  ...
  },
  {
    ...
    color: "amber",
    points: [
      { label: "कहाँ जाएं", text: "ऊपर header में ⚙️ सेटिंग पर जाएं।" },
  ...
  },
  {
    ...
    points: [
      ...
      { label: "सोने का भाव", text: "होम पेज पर 📈 भाव दबाएं → सोना चुनें → टंच चुनें (24K / 22K / 18K / 916 / 750) → प्रति 10 ग्राम का भाव डालें → सेव करें।" },
  ...
  },
  {
    step: "५",
    icon: "📦",
    title: "स्टॉक में सामान जोड़ें — हर गहने का बारकोड बनवाएं",
    color: "amber",
    points: [
      { label: "क्यों ज़रूरी", text: "हर गहने का अलग बारकोड हो तो बिल बनाते समय बस स्कैन करना है — सब जानकारी अपने आप भर जाएगी।" },
      { label: "नया सामान जोड़ें", text: "नीचे मेनू में 📦 स्टॉक → '+ नया सामान' → सामान का नाम, धातु, टंच, वजन, मेकिंग चार्ज भरें।" },
      { label: "हॉलमार्क / HUID", text: "अगर सामान हॉलमार्क है तो हॉलमार्क नंबर और HUID भरें — वैकल्पिक है। यह जानकारी बिल पर भी छपेगी।" },
      { label: "बारकोड अपने आप बनेगा", text: "सेव दबाते ही एक नया बारकोड (जैसे SKU1234567) बन जाएगा। उसे label printer से छाप कर गहने पर चिपकाएं।" },
      { label: "स्टॉक की सूची", text: "कितना सामान उपलब्ध है, कुल कितने ग्राम का माल है — होम पेज पर एक कार्ड में दिखता है।" },
    ],
  },
  {
    step: "६",
    ...
    points: [
      ...
      { label: "गिरवी बंद करना", text: "जब ग्राहक सामान छुड़ाने आए — उस एंट्री पर 'वापस मिली' दबाएं। रिकॉर्ड 'बंद' टैब में सुरक्षित रहेगा।" },
  ...
  },
  {
    step: "७",
    icon: "🧾",
    title: "बिल बनाएं — सीधा या पुराना सोना देकर",
    color: "amber",
    points: [
      { label: "बारकोड स्कैन करें", text: "बिल पेज खोलते ही ऊपर बारकोड बॉक्स है — गहने का बारकोड स्कैन करें या टाइप करें → पूरा form अपने आप भर जाएगा (सामान का नाम, वजन, हॉलमार्क सब)।" },
      { label: "बिना बारकोड के", text: "अगर गहना बिना बारकोड का है — हाथ से ग्राहक का नाम, सामान, धातु, टंच, वजन, मेकिंग भरें।" },
      { label: "GST और हॉलमार्क", text: "GST 3% अपने आप जुड़ती है। हॉलमार्क नंबर और HUID भरें (अगर हो) — बिल पर छपेंगे।" },
      { label: "पुराना सोना देकर नया लेना", text: "अगर ग्राहक पुराना सोना देकर नया गहना ले रहा है — 'पुराना सोना देना है?' बटन दबाएं → पुराने का वजन, टंच, भाव भरें → कुल बिल से अपने आप घट जाएगा। 'देनी रकम' = नया बिल − पुराना सोना।" },
      { label: "भुगतान का तरीका", text: "नकद, UPI, उधार — जो हो वह चुनें।" },
      { label: "WhatsApp पर भेजें", text: "बिल बनने के बाद '💬 WhatsApp' दबाएं — ग्राहक को सीधे बिल का मैसेज चला जाएगा।" },
  ...
  },
  {
    step: "८",
    icon: "♻️",
    title: "ग्राहक से पुराना सोना खरीदें (URD)",
    color: "amber",
    points: [
      { label: "क्या है URD", text: "जब ग्राहक सिर्फ पुराना सोना/चाँदी बेचने आए (कुछ नया नहीं ले रहा) — वो URD खरीदी कहलाती है। आयकर विभाग के लिए ज़रूरी है पूरा रिकॉर्ड रखना।" },
      { label: "नई खरीदी", text: "नीचे मेनू में ♻️ पुराना → '+ नई खरीदी' → ग्राहक का नाम और मोबाइल भरें।" },
      { label: "पहचान पत्र", text: "आधार / पैन / वोटर ID / DL में से एक चुनें और नंबर भरें — कानूनी रूप से ज़रूरी है।" },
      { label: "धातु, वजन, भाव", text: "धातु (सोना/चाँदी), टंच और वजन भरें। भाव अपने आप आज के भाव का 90% भर जाता है (पुराना सोना हमेशा कम भाव में लिया जाता है) — चाहें तो बदल सकते हैं।" },
      { label: "देनी रकम", text: "वजन × भाव अपने आप जुड़कर कुल रकम दिख जाती है। नकद, UPI या बैंक — जो दिया वह चुनें।" },
      { label: "इतिहास", text: "सब URD खरीदी 'इतिहास' टैब में सुरक्षित — कुल कितना खर्च हुआ वो भी ऊपर दिखता है।" },
    ],
  },
  {
    step: "९",
    ...
    color: "amber",
    points: [
      { label: "कारीगर जोड़ें", text: "होम पेज पर 🔨 कारीगर → '+ कारीगर' दबाएं → नाम और मोबाइल नंबर भरें → सेव करें। यह एक बार करना है।" },
  ...
  },
  {
    step: "१०",
    icon: "📊",
    title: "बिक्री रिपोर्ट देखें — रोज़ शाम",
    color: "amber",
    points: [
      { label: "कहाँ है", text: "होम पेज पर सबसे ऊपर बड़ा भूरा कार्ड है — 'आज की बिक्री'। उस पर दबाएं — पूरी रिपोर्ट खुलेगी।" },
      { label: "तीन अवधियाँ", text: "आज, हफ्ता, महीना — ऊपर के बटनों से कोई भी चुनें।" },
      { label: "क्या दिखता है", text: "कुल बिक्री और बिल की संख्या, कितना सोना और कितनी चाँदी बिकी (ग्राम में), मेकिंग से कुल कमाई, GST जमा हुई।" },
      { label: "भुगतान का breakup", text: "कितना नकद आया, कितना UPI में, और कितना उधार — तीनों अलग-अलग दिखते हैं। उधार वाला रकम लाल रंग में दिखता है ताकि याद रहे कि वसूलना है।" },
      { label: "रोज़ शाम देखें", text: "हर शाम दुकान बंद करने से पहले एक नज़र मारें — पूरे दिन का हिसाब एक झलक में।" },
    ],
  },
];
    ...
    <main className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="bg-gradient-to-br from-[#8B5E52] via-[#AA7D6E] to-[#C4957F] text-white py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl mb-2 font-semibold text-white/90">
            गिरवी, कारीगर, भाव, बिल, स्टॉक — सब एक जगह।
          </p>
          <p className="text-base mb-10 text-white/70">
            हिंदी में · मोबाइल पर · बारकोड · WhatsApp बिल · GST ready
          </p>
      ...
      <section className="py-12 px-4 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-400 text-base mb-8">सुनार की दुकान के लिए बनाया गया — १० बड़ी खूबियाँ</p>
        ...
        <div className="max-w-3xl mx-auto">
                    ...
                    <div className="border-t border-amber-100 px-5 py-4 space-y-3">
                      {s.points.map((p, i) => (
                        <div key={i} className="flex gap-3">
                          <span className="mt-2 w-2 h-2 rounded-full bg-[#AA7D6E] shrink-0" />
                          <div>
          ...
          <div className="mt-8 bg-[#AA7D6E]/10 border border-[#AA7D6E]/30 rounded-2xl px-5 py-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              हर सुबह सबसे पहले <strong>📈 भाव</strong> पेज पर जाकर आज का सोने-चाँदी का भाव डालें — इसके बाद ही बिल सही बनेगा।
              और हर शाम दुकान बंद करते समय <strong>📊 बिक्री रिपोर्ट</strong> ज़रूर देखें।
            </p>
          </div>

          {/* नई खूबियाँ का highlight */}
          <div className="mt-4 bg-amber-100 border border-amber-300 rounded-2xl px-5 py-4">
            <p className="text-sm font-black text-amber-800 mb-2">✨ नई खूबियाँ — अभी जोड़ी गईं</p>
            <ul className="text-sm text-gray-700 space-y-1 leading-relaxed">
              <li>• <strong>📦 स्टॉक + बारकोड</strong> — हर गहने का अलग बारकोड, स्कैन करते ही बिल बने</li>
              <li>• <strong>♻️ पुराना खरीदा (URD)</strong> — आधार/पैन सहित ग्राहक से पुराना सोना खरीदने का पूरा रिकॉर्ड</li>
              <li>• <strong>🔁 पुराना सोना देकर नया</strong> — बिल में अपने आप घटेगा</li>
              <li>• <strong>📊 बिक्री रिपोर्ट</strong> — आज, हफ्ता, महीना — पूरा हिसाब एक क्लिक में</li>
              <li>• <strong>🏷️ हॉलमार्क + HUID</strong> — बिल पर अपने आप छपेंगे</li>
            </ul>
          </div>
