  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 font-sans">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 leading-tight">
            ...
            <span className="text-green-200">
              होम्योपैथी क्लिनिक का डिजिटल सहायक
            </span>
          </h1>
          ...
          <div className="flex flex-col items-center gap-4 mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white text-green-800 font-extrabold text-xl px-10 py-4 rounded-2xl shadow-xl hover:bg-green-50 transition"
            >
              📱 Android पर Install करें
            </a>
            <a
              href={HOMEO_EXE_URL}
              className="flex items-center gap-2 bg-white/15 border border-white/30 text-white font-bold text-lg px-8 py-3 rounded-2xl hover:bg-white/25 transition"
            >
      ...
      <section className="py-8 px-4 bg-yellow-50 border-b-4 border-yellow-400">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl border-2 border-yellow-400 p-6 shadow">
          <p className="text-xl font-extrabold text-gray-800 mb-3">
            ⚠️ इंस्टॉल करते समय यह संदेश आ सकता है — घबराएं नहीं
          </p>
          <p className="text-base text-gray-600 mb-3">
            Windows 11 में Smart App Control नाम की सुरक्षा होती है। यह
            सॉफ्टवेयर पूरी तरह सुरक्षित है।
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-6 border border-gray-200 rounded-2xl">
              ...
              <p className="text-gray-600">
                मालिक पहले लॉगिन करें — फिर डॉक्टरों को मंजूरी दें।
              </p>
            </div>
            <div className="p-6 border border-gray-200 rounded-2xl">
              <div className="text-4xl mb-4">⚙️</div>
              <h3 className="text-xl font-bold mb-2">
                क्लिनिक की जानकारी भरें
              </h3>
              <p className="text-gray-600">
                क्लिनिक का नाम, पता, रजिस्ट्रेशन नंबर डालें।
              </p>
            </div>
            <div className="p-6 border border-gray-200 rounded-2xl">
              <div className="text-4xl mb-4">👨‍⚕️</div>
              ...
              <p className="text-gray-600">
                डॉक्टर गूगल से लॉगिन करें — मालिक उन्हें मंजूरी दें।
              </p>
            </div>
            <div className="p-6 border border-gray-200 rounded-2xl">
              <div className="text-4xl mb-4">📋</div>
              ...
              <p className="text-gray-600">
                डॉक्टर पर्चा लिखें — काउंटर पर फौरन दिखे।
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-3">
              PIN क्या है? कैसे बनाएं?
            </h2>
            <p className="text-gray-700 text-lg">
              4 अंकों का छोटा पासवर्ड — जैसे ATM कार्ड का PIN।
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-amber-400 p-6 mb-6 shadow">
            ...
            <ul className="space-y-3 text-gray-800 text-base">
              <li className="flex items-start gap-3">
                <span className="text-green-600 text-xl font-bold mt-0.5">
                  ✓
                </span>
                <span>
                  <strong>मालिक Gmail से login करता है</strong> — उसे PIN की
                  जरूरत नहीं।
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>
                    डॉक्टर और काउंटर स्टाफ सिर्फ PIN से login करते हैं
                  </strong>{" "}
                  — Gmail की जरूरत नहीं (पहली बार को छोड़कर)।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-green-600 text-xl font-bold mt-0.5">
                ...
                <span>
                  <strong>मालिक ही सबका PIN बनाता है</strong> — डॉक्टर या स्टाफ
                  खुद नहीं बना सकते।
                </span>
              </li>
            </ul>
          ...
          <div className="bg-white rounded-2xl border-2 border-orange-400 p-6 mb-6 shadow">
            <p className="text-xl font-black text-orange-700 mb-2">
              👑 मालिक के लिए: PIN कैसे सेट करें?
            </p>
            <p className="text-sm text-gray-600 mb-4">तीन आसान कदम:</p>
            <ol className="space-y-4 text-gray-800 text-base">
              <li className="flex items-start gap-3">
                <span className="bg-orange-500 text-white font-black w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0">
                  १
                </span>
                <span>
                  Owner Panel खोलें → ऊपर <strong>"🔐 PIN Setup"</strong> वाली
                  tab पर क्लिक करें।
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  जिस डॉक्टर या स्टाफ को PIN देना है, उसके सामने के खाने में{" "}
                  <strong>4 अंक</strong> डालें।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="bg-orange-500 text-white font-black w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <span>
                  <strong>"Set"</strong> बटन दबाएं → हो गया। ✅
                </span>
              </li>
            </ol>
            <div className="mt-5 bg-orange-50 border border-orange-300 rounded-xl p-4 text-sm text-orange-900">
              💡 <strong>PIN बदलना है?</strong> वही तरीका — नया PIN डालें और Set
              करें। पुराना PIN अपने आप बदल जाएगा।
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-amber-400 p-6 shadow">
            ...
            <ul className="space-y-3 text-gray-800 text-base">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>डॉक्टर को पहले Approve करें, फिर PIN दें।</strong>{" "}
                  बिना Approve किए PIN काम नहीं करेगा।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-600 text-xl mt-0.5">•</span>
                <span>
                  <strong>PIN किसी को लिखकर न दें</strong> — सीधे मुंह से बताएं।
                  कागज पर लिखा PIN कोई भी देख सकता है।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-600 text-xl mt-0.5">•</span>
                <span>
                  <strong>डॉक्टर के जाने पर उसका PIN तुरंत बदल दें</strong> —
                  ताकि पुराना कर्मचारी अंदर न आ सके।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-600 text-xl mt-0.5">•</span>
                <span>
                  <strong>कोई PIN भूल गया?</strong> मालिक Settings में जाकर नया
                  PIN सेट कर देगा — पुराना अपने आप खत्म।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-600 text-xl mt-0.5">•</span>
                <span>
                  <strong>दो लोगों का एक जैसा PIN नहीं हो सकता।</strong>{" "}
                  सॉफ्टवेयर खुद रोक देगा।
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="py-16 px-4 bg-green-50">
        <h2 className="text-center text-3xl font-black text-green-900 mb-4">
          आप कौन हैं?
        </h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          सॉफ्टवेयर में तीन तरह के लोग काम करते हैं — मालिक, डॉक्टर और काउंटर
          स्टाफ। हर किसी का login अलग है। नीचे अपना रोल देखें।
        </p>
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-orange-50 border-2 border-orange-400 rounded-2xl p-6">
            ...
            <p className="text-sm text-orange-700 font-semibold mb-5">
              Login: हमेशा Gmail से
            </p>
            <ul className="space-y-4 text-gray-700 text-sm">
              <li className="flex items-start gap-3">
                <span className="font-bold text-orange-600 mt-0.5">१.</span>
                <span>
                  सॉफ्टवेयर खोलें → <strong>"Google से Login करें"</strong> बटन
                  दबाएं → अपनी Gmail से sign in करें। यह सिर्फ एक बार होता है।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-orange-600 mt-0.5">२.</span>
                <span>
                  Settings में जाकर क्लिनिक का नाम, पता और रजिस्ट्रेशन नंबर
                  भरें।
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  जब डॉक्टर पहली बार Gmail से login करे, तो मालिक के panel में
                  उनका नाम दिखेगा — <strong>Approve</strong> करें।
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>
                    डॉक्टर और काउंटर स्टाफ का 4 अंकों का PIN सेट करें
                  </strong>{" "}
                  — Settings → Staff → PIN बदलें। यह PIN ही उनका रोज़ का पासवर्ड
                  है।
                </span>
              </li>
              <li className="flex items-start gap-3">
            ...
            <div className="mt-5 bg-orange-100 border border-orange-300 rounded-xl p-3 text-xs text-orange-800">
              ⚠️ <strong>ज़रूरी:</strong> जब तक मालिक किसी का PIN सेट नहीं करता,
              वह व्यक्ति login नहीं कर सकता। पहले Approve करें, फिर PIN दें।
            </div>
          </div>
          ...
          <div className="bg-green-50 border-2 border-green-500 rounded-2xl p-6">
            ...
            <p className="text-sm text-green-700 font-semibold mb-5">
              Login: पहली बार Gmail से, उसके बाद हर बार PIN से
            </p>
            <ul className="space-y-4 text-gray-700 text-sm">
              <li className="flex items-start gap-3">
                <span className="font-bold text-green-600 mt-0.5">१.</span>
                <span>
                  <strong>सिर्फ पहली बार:</strong> सॉफ्टवेयर खोलें → Doctor card
                  के नीचे छोटा लिंक दिखेगा{" "}
                  <strong>"पहली बार? Gmail से register करें"</strong> → उस पर
                  क्लिक करके अपनी Gmail से sign in करें। यह सिर्फ एक बार करना है
                  ताकि मालिक आपको पहचान सके।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-green-600 mt-0.5">२.</span>
                <span>
                  मालिक आपको Approve करेगा और एक <strong>4 अंकों का PIN</strong>{" "}
                  देगा। यह PIN संभालकर रखें।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-green-600 mt-0.5">३.</span>
                <span>
                  <strong>रोज़ का login:</strong> सॉफ्टवेयर खोलें → "Doctor PIN
                  Login" → अपना 4 अंकों का PIN डालें। Gmail की जरूरत नहीं।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-green-600 mt-0.5">४.</span>
                <span>
                  मरीज का नाम या मोबाइल नंबर डालकर खोजें, या नया मरीज बनाएं।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-green-600 mt-0.5">५.</span>
                <span>
                  शिकायत लिखें → दवा चुनें → पोटेंसी, मात्रा और समय भरें → Save
                  करें। पर्चा उसी पल काउंटर पर पहुँच जाएगा।
                </span>
              </li>
            </ul>
            <div className="mt-5 bg-green-100 border border-green-300 rounded-xl p-3 text-xs text-green-800">
              💡 <strong>PIN भूल गए?</strong> मालिक से कहें — वह Settings में
              जाकर नया PIN सेट कर देगा। Gmail से दोबारा login की जरूरत नहीं।
            </div>
          </div>
          ...
          <div className="bg-blue-50 border-2 border-blue-400 rounded-2xl p-6">
            ...
            <p className="text-sm text-blue-700 font-semibold mb-5">
              Login: हमेशा सिर्फ PIN से — Gmail की कोई जरूरत नहीं
            </p>
            <ul className="space-y-4 text-gray-700 text-sm">
              <li className="flex items-start gap-3">
                <span className="font-bold text-blue-600 mt-0.5">१.</span>
                <span>
                  सबसे पहले मालिक से अपना <strong>4 अंकों का PIN</strong> लें।
                  बिना PIN के login नहीं होगा।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-blue-600 mt-0.5">२.</span>
                <span>
                  सॉफ्टवेयर खोलें → <strong>"Counter PIN Login"</strong> → अपना
                  PIN डालें → अंदर आ जाएं। इतना ही काफी है।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-blue-600 mt-0.5">३.</span>
                <span>
                  नए पर्चे की सूची अपने आप दिखेगी — जैसे ही डॉक्टर save करेगा।
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="font-bold text-blue-600 mt-0.5">४.</span>
                <span>
                  दवाएं निकालें → Dispense करें → चाहें तो Print निकालें या मरीज
                  को स्क्रीन दिखाएं।
                </span>
              </li>
              <li className="flex items-start gap-3">
            ...
            <div className="mt-5 bg-blue-100 border border-blue-300 rounded-xl p-3 text-xs text-blue-800">
              💡 <strong>PIN नहीं मिला या भूल गए?</strong> मालिक से संपर्क करें
              — वही PIN बनाता और बदलता है। आपको कोई Gmail account की जरूरत नहीं
              है।
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-12 text-green-400">
            क्या-क्या मिलेगा?
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              ...
              <p className="text-gray-300 text-sm">
                डॉक्टर पर्चा लिखते हैं — काउंटर पर तुरंत पहुँच जाता है। कागज की
                जरूरत नहीं।
              </p>
            </div>
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              ...
              <p className="text-gray-300 text-sm">
                1 से 5 डॉक्टर अपने-अपने लॉगिन से एक साथ काम कर सकते हैं।
              </p>
            </div>
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              <div className="text-4xl mb-4">💊</div>
              ...
              <p className="text-gray-300 text-sm">
                होम्योपैथी की सभी दवाएं और पोटेंसी ड्रॉपडाउन में पहले से मौजूद
                हैं।
              </p>
            </div>
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              ...
              <p className="text-gray-300 text-sm">
                डॉक्टर सेव करें — उसी पल काउंटर पर दिख जाए। कोई देरी नहीं।
              </p>
            </div>
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              <div className="text-4xl mb-4">🔍</div>
              ...
              <p className="text-gray-300 text-sm">
                नाम या मोबाइल नंबर से मरीज को पलभर में खोजें।
              </p>
            </div>
            <div className="bg-gray-800 border border-green-900/40 rounded-xl p-6">
              <div className="text-4xl mb-4">📦</div>
              ...
              <p className="text-gray-300 text-sm">
                कौन सी दवा है, कौन सी खत्म है — सब एक जगह दिखेगा।
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-2xl border-2 border-green-600 p-8 text-center shadow-lg relative bg-white">
              ...
              <button
                onClick={pay}
                className="block w-full bg-gray-800 text-white font-bold py-4 rounded-xl hover:bg-gray-700 transition text-lg"
              >
                💳 अभी खरीदें — ₹4,999
              </button>
            </div>
            <div className="rounded-2xl border-2 border-gray-200 p-8 text-center shadow-sm bg-white">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full bg-green-600 text-white font-bold py-4 rounded-xl hover:opacity-90 transition text-lg"
              >
                💬 व्हाट्सएप करें
              </a>
            </div>
      ...
      <section className="bg-green-700 py-16 px-4 text-center text-white">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-white/80 mb-8 text-lg">
            ७ दिन पूरी तरह मुफ्त — कोई कार्ड नहीं
          </p>
