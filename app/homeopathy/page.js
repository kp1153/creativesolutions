...
// --- Data (Copied from your page.js, kept as is) ---
...
function PaymentButton() {
  // ✅ CORRECT for Next.js 16: searchParams is used inside a component that is wrapped in Suspense
  // We'll get email from URL using window.location to avoid Promise handling complexity here
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="py-8 px-4 bg-yellow-50 border-b-4 border-yellow-400">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl border-2 border-yellow-400 p-6 shadow">
          ...
          <p className="text-base text-gray-600 mb-3">
            Windows 11 में <strong>Smart App Control</strong> नाम की सुरक्षा होती है। यह
          ...
          <ol className="text-base text-gray-600 space-y-1 list-decimal list-inside">
            ...
            <li>
              <strong>App &amp; browser control</strong> पर क्लिक करें
            </li>
            <li>
              <strong>Smart App Control</strong> को <strong>बंद (Off)</strong> करें
            </li>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-amber-50 border-2 border-amber-400 rounded-2xl p-6 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-black text-amber-700">मालिक</h3>
              </div>
              <ul className="space-y-3">
                {["Google से Login करें", "क्लिनिक का नाम, पता और रजिस्ट्रेशन नंबर भरें", "डॉक्टर और काउंटर स्टाफ को मंजूरी दें", "दवाओं का स्टॉक जोड़ें और मैनेज करें", "सभी पर्चे और रिपोर्ट देखें"].map((text, idx) => (
                  <li key={idx} className="flex gap-2 items-start">
                    <span className="bg-amber-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center mt-0.5 flex-shrink-0">{idx+1}</span>
            ...
            <div className="bg-green-50 border-2 border-green-400 rounded-2xl p-6 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl">🩺</span>
                <h3 className="text-2xl font-black text-green-700">डॉक्टर</h3>
              </div>
              <ul className="space-y-3">
                {["Google से Login करें — मालिक से मंजूरी लें", "मरीज का नाम या मोबाइल से खोजें या नया बनाएं", "शिकायत लिखें और दवाएं चुनें", "पोटेंसी, मात्रा और समय भरें", "Save करें — पर्चा काउंटर पर फौरन पहुँच जाएगा"].map((text, idx) => (
                  <li key={idx} className="flex gap-2 items-start">
                    <span className="bg-green-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center mt-0.5 flex-shrink-0">{idx+1}</span>
                    <span className="text-gray-800 font-medium">{text}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-blue-50 border-2 border-blue-400 rounded-2xl p-6 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl">💊</span>
                <h3 className="text-2xl font-black text-blue-700">काउंटर स्टाफ</h3>
              </div>
              <ul className="space-y-3">
                {["4 अंकों का PIN डालकर Login करें", "नए पर्चे की सूची देखें", "दवाएं निकालें और Dispense करें", "Print निकालें या मरीज को दिखाएं", "स्टॉक कम हो तो मालिक को बताएं"].map((text, idx) => (
                  <li key={idx} className="flex gap-2 items-start">
                    <span className="bg-blue-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center mt-0.5 flex-shrink-0">{idx+1}</span>
                    <span className="text-gray-800 font-medium">{text}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="py-16 px-4 bg-gray-900 text-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-2 text-green-400">
            क्या-क्या मिलेगा?
          </h2>
          <p className="text-center text-gray-400 text-base mb-12">
            होम्योपैथी क्लिनिक के लिए खास बनाया गया
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div
                key={i}
                className="bg-gray-800 border border-green-900/40 rounded-xl p-5 hover:border-green-500/50 transition"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {howTo.map((h) => (
              <div
                key={h.step}
                className="bg-white border border-green-200 rounded-xl p-5 text-center shadow-sm hover:shadow-md transition"
              >
                <div className="w-10 h-10 bg-green-700 text-white font-black rounded-full flex items-center justify-center mx-auto mb-3 text-lg">
                  {h.step}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-2xl border-2 border-green-600 p-6 text-center shadow-lg relative bg-white">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-green-600 text-white text-sm font-bold px-5 py-1 rounded-full whitespace-nowrap">
                नया खाता
              </div>
