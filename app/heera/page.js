...
const डाउनलोड_लिंक = "https://pub-31ce429b28bc4ce8bf56e0a2af375815.r2.dev/Heera%20Desk%200.1.0.exe";

const खासियत = [
  { आइकन: "💎", शीर्षक: "कच्चा माल रिकॉर्ड", विवरण: "कितना कच्चा हीरा है — वजन, गुणवत्ता, लॉट नंबर सब दर्ज होगा। कुछ भी गुम नहीं होगा।" },
  { आइकन: "👨‍🏭", शीर्षक: "कारीगर का हिसाब", विवरण: "किस कारीगर को कितना लॉट दिया, कब वापस आएगा, मजदूरी कितनी बनी — सब एक जगह।" },
  { आइकन: "✨", शीर्षक: "पॉलिश माल रिकॉर्ड", विवरण: "पॉलिश हुए हीरों का पूरा रिकॉर्ड — आकार, रंग, चमक, कैरेट।" },
  { आइकन: "📒", शीर्षक: "पार्टी बही-खाता", विवरण: "किस पार्टी को क्या बेचा, भुगतान कब आया, कितना बाकी है — सब साफ दिखेगा।" },
  { आइकन: "💰", शीर्षक: "मजदूरी हिसाब", विवरण: "कारीगर को कितना देना है, कितना अग्रिम दिया, कितना बाकी है — हर महीने पर्ची छापो।" },
  { आइकन: "📉", शीर्षक: "घटान का हिसाब", विवरण: "कच्चे से पॉलिश में कितना वजन घटा — उत्पादन घाटे का पूरा हिसाब।" },
  { आइकन: "📦", शीर्षक: "खरीद का हिसाब", विवरण: "कच्चा माल कहाँ से आया, भाव क्या था, कितना माल आया — सब दर्ज।" },
  { आइकन: "📊", शीर्षक: "महीने का नफा-नुकसान", विवरण: "महीने के अंत में देखो — कितनी खरीद, कितनी बिक्री, कितना फायदा।" },
  { आइकन: "☁️", शीर्षक: "कहीं से भी खोलो", विवरण: "घर से, दुकान से, मोबाइल से — जहाँ इंटरनेट है वहाँ से खोलो। डेटा सुरक्षित रहेगा।" },
  { आइकन: "🔐", शीर्षक: "गूगल से लॉगिन", विवरण: "पासवर्ड याद रखने की ज़रूरत नहीं — अपने गूगल खाते से सीधे लॉगिन करो।" },
];
...
export default function HeeraPage() {
  return (
    <main className="min-h-screen bg-white text-gray-900" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>
      ...
      <section className="py-16 px-4 bg-gray-900 text-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-3 text-cyan-400">इसमें क्या-क्या है?</h2>
          <p className="text-center text-gray-400 text-lg mb-10">हीरा व्यापारियों और निर्माताओं के लिए बनाया गया</p>
          <div className="grid md:grid-cols-2 gap-5">
            {खासियत.map((ख, i) => (
              <div key={i} className="bg-gray-800 border border-cyan-500/20 rounded-2xl px-6 py-5">
                <div className="text-3xl mb-2">{ख.आइकन}</div>
                <div className="text-cyan-400 font-extrabold text-xl mb-2">{ख.शीर्षक}</div>
                <div className="text-gray-300 text-base leading-relaxed">{ख.विवरण}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-cyan-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-10 text-gray-800">कैसे चलाएं?</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {कैसेचलाएं.map((क) => (
              <div key={क.नंबर} className="bg-white border border-cyan-200 rounded-2xl p-6 text-center shadow-sm">
                <div className="text-4xl mb-3">{क.आइकन}</div>
                <div className="text-cyan-600 font-extrabold text-lg mb-1">चरण {क.नंबर}</div>
                <div className="font-extrabold text-gray-800 text-lg mb-2">{क.काम}</div>
                <div className="text-gray-500 text-base leading-relaxed">{क.विवरण}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-10 text-gray-800">मूल्य</h2>
