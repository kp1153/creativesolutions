    ...
    <main className="min-h-screen bg-zinc-900 text-white font-sans">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs mt-1 text-zinc-400 font-medium">👉 Chrome menu ⋮ → Add to Home Screen → Install</p>
            </div>
          </div>
          <p className="text-sm mt-3 text-zinc-400 font-medium">Windows 10/11 — 64-bit &nbsp;|&nbsp; Android Chrome पर भी चलता है</p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-zinc-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-extrabold text-center mb-1 text-white">खासियत / Features</h2>
          <p className="text-center text-zinc-300 font-medium text-sm mb-8">Tally / ERP users के लिए — For Tally / ERP Users</p>
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            {features.map((f, i) => (
              <div key={i} className="bg-zinc-800 border border-zinc-600 rounded-xl px-5 py-4">
                <div className="text-white font-bold text-sm mb-1">✦ {f.hi}</div>
                <div className="text-zinc-300 font-medium text-xs">{f.en}</div>
              </div>
            ))}
          </div>

          <h2 className="text-2xl font-extrabold text-center mb-1 text-white">FMCG Companies के लिए</h2>
          <p className="text-center text-zinc-300 font-medium text-sm mb-8">200 parties, 20 SO, 5 ASM — सब एक dashboard पर</p>
      ...
      <section className="py-14 px-4 bg-zinc-800">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-extrabold text-center mb-1 text-white">🔄 Tally Auto-Sync कैसे करें</h2>
            ...
            {syncSteps.map((s) => (
              <div key={s.step} className="bg-zinc-900 border border-zinc-700 rounded-2xl px-6 py-5 flex gap-5 items-start">
                ...
                <div>
                  ...
                  <div className="text-zinc-300 font-semibold text-xs mb-2">{s.en}</div>
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-zinc-400 font-medium text-xs mt-2">Windows 10/11 only — free download</p>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border-2 border-white p-6 text-center shadow-lg relative bg-zinc-800">
              ...
              <div className="text-4xl font-extrabold text-white mb-1">₹11,999</div>
            ...
            <div className="rounded-2xl border-2 border-zinc-600 p-6 text-center shadow-sm bg-zinc-800">
              ...
              <div className="text-4xl font-extrabold text-white mb-1">₹4,999</div>
