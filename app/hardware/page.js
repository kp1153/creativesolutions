      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 text-white py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl mb-3 font-semibold text-blue-100">
            हार्डवेयर की दुकान के लिए बना — बिल, स्टॉक, उधारी, जीएसटी सब एक जगह।
          </p>
      ...
      <section className="py-8 px-4 bg-yellow-50 border-b-4 border-yellow-400">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl border-2 border-yellow-400 p-6 shadow">
          ...
          <p className="text-base text-gray-600 mb-4">
            विंडोज 11 में <strong>Smart App Control</strong> नाम की सुरक्षा होती
            है जो नए सॉफ्टवेयर को रोकती है। घबराएं नहीं — यह सॉफ्टवेयर पूरी तरह
            सुरक्षित है।
          </p>
          ...
          <ol className="text-base text-gray-700 space-y-2">
            ...
            <li>
              ३. <strong>Smart App Control</strong> को <strong>Off</strong> करो
            </li>
      ...
      <section className="py-12 px-4 bg-blue-50">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-gray-500 text-base mb-8">
            बस ४ काम करने हैं — ५ मिनट में दुकान तैयार
          </p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-extrabold text-center mb-2 text-gray-800">
            विस्तार से समझो — कैसे उपयोग करें
          </h2>
          <p className="text-center text-gray-500 text-base mb-10">
            हर काम आसान हिंदी में समझाया गया है
          </p>
                ...
                <ol className="space-y-2">
                  {k.steps.map((s, j) => (
                    <li key={j} className="flex gap-3 items-start">
                      <span className="bg-blue-600 text-white text-xs font-extrabold rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                        {j + 1}
                      </span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border-2 border-blue-500 p-6 text-center shadow-lg relative">
              ...
              <a
                ...
                className="block w-full bg-blue-600 text-white font-extrabold py-3 rounded-xl hover:bg-blue-500 transition text-lg"
              >
                मुफ्त में आज़माएँ
              </a>
            </div>
      ...
      <section className="bg-blue-700 py-12 px-4 text-center text-white">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-blue-200 mb-6 text-base">
            ७ दिन पूरी तरह मुफ्त — कोई कार्ड नहीं, कोई वादा नहीं
          </p>
