...
const products = [
  { key: "erpbridge", icon: "📊", title: "ERPBridge", subtitle: "Business Intelligence", descHi: "Tally, Busy, Marg का data — Sales, Purchase, P&L, Ledger एक जगह", descEn: "Upload Tally data — instant Sales, Purchase, P&L & Ledger reports", exeUrl: ERPBRIDGE_EXE_URL, pwaUrl: ERPBRIDGE_PWA_URL, software: "erpbridge", newPrice: "₹25,000", renewPrice: "₹2,500", accentText: "text-yellow-400", accentBorder: "border-yellow-500", accent: "bg-yellow-500" },
  { key: "dental", icon: "🦷", title: "Dental Pro", subtitle: "Clinic Management", descHi: "डेंटल क्लिनिक के लिए — मरीज, prescription, treatment, billing", descEn: "Patients, Prescriptions, Treatments & Billing — all in one place", exeUrl: DENTAL_EXE_URL, pwaUrl: DENTAL_PWA_URL, software: "dental", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-green-400", accentBorder: "border-green-500", accent: "bg-green-600" },
  { key: "hardware", icon: "🔧", title: "Hardware Pro", subtitle: "Shop Management", descHi: "हार्डवेयर दुकान के लिए — बिल, स्टॉक, उधारी, GST", descEn: "Billing, stock, credit & GST reports for hardware shops", exeUrl: HARDWARE_EXE_URL, pwaUrl: HARDWARE_PWA_URL, software: "hardware", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-blue-400", accentBorder: "border-blue-500", accent: "bg-blue-600" },
  { key: "school", icon: "🏫", title: "निशांत स्कूल सॉफ्टवेयर", subtitle: "School Management", descHi: "CBSE स्कूलों के लिए — Students, Fees, Attendance, Exams", descEn: "Students, Fees, Attendance, Exams & Parent Portal all in one place", exeUrl: SCHOOL_EXE_URL, pwaUrl: "https://school.nishantsoftwares.in", software: "school", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-indigo-400", accentBorder: "border-indigo-500", accent: "bg-indigo-600" },
  { key: "ration", icon: "🏪", title: "Ration Pro", subtitle: "राशन दुकान प्रबंधन", descHi: "राशन की दुकान के लिए — स्टॉक, बिक्री, उधारी सब एक जगह", descEn: "Stock, sales & credit management for ration shops", exeUrl: "", pwaUrl: "#", software: "ration", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-orange-400", accentBorder: "border-orange-500", accent: "bg-orange-500" },
  { key: "pharma", icon: "💊", title: "Pharma Pro", subtitle: "Medical Store Management", descHi: "दवा की दुकान के लिए — stock, expiry, billing, GST", descEn: "Medicine stock, expiry alerts, billing & GST for pharmacies", exeUrl: "", pwaUrl: "#", software: "pharma", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-red-400", accentBorder: "border-red-500", accent: "bg-red-600" },
  { key: "heera", icon: "💎", title: "Heera Pro", subtitle: "हीरा उद्योग प्रबंधन", descHi: "हीरा उद्योग के लिए — rough, polished, karigar, party ledger", descEn: "Diamond industry — rough tracking, karigar management & party ledger", exeUrl: "https://pub-31ce429b28bc4ce8bf56e0a2af375815.r2.dev/Heera%20Desk%20Setup%200.1.0.exe", pwaUrl: "https://heera.nishantsoftwares.in", software: "heera", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-cyan-400", accentBorder: "border-cyan-500", accent: "bg-cyan-600" },
  { key: "clinic", icon: "🏥", title: "Clinic Pro", subtitle: "सामान्य क्लिनिक", descHi: "डॉक्टर के क्लिनिक के लिए — OPD, prescription, billing", descEn: "OPD management, prescriptions & billing for general clinics", exeUrl: CLINIC_EXE_URL, pwaUrl: CLINIC_PWA_URL, software: "clinic", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-teal-400", accentBorder: "border-teal-500", accent: "bg-teal-600" },
  { key: "legal", icon: "⚖️", title: "Legal Pro", subtitle: "वकीलों के लिए", descHi: "वकीलों के लिए — cases, clients, dates, documents", descEn: "Cases, clients, court dates & document management for lawyers", exeUrl: "", pwaUrl: "#", software: "legal", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-purple-400", accentBorder: "border-purple-500", accent: "bg-purple-600" },
  { key: "hotel", icon: "🏨", title: "Hotel Pro", subtitle: "Hotel Management", descHi: "होटल के लिए — rooms, booking, billing, staff", descEn: "Room booking, billing & staff management for hotels", exeUrl: HOTEL_EXE_URL, pwaUrl: "/hotel", software: "hotel", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-pink-400", accentBorder: "border-pink-500", accent: "bg-pink-600" },
  ...
  { key: "psychiatrist", icon: "🧠", title: "Psychiatrist Pro", subtitle: "मानसिक स्वास्थ्य क्लिनिक", descHi: "मनोचिकित्सक के लिए — मरीज, पर्चा, दवा, follow-up reminder", descEn: "Patients, prescriptions, medicines & follow-up SMS reminders", exeUrl: PSYCHIATRIST_EXE_URL, pwaUrl: PSYCHIATRIST_PWA_URL, software: "psychiatrist", newPrice: "₹4,999", renewPrice: "₹2,500", accentText: "text-violet-400", accentBorder: "border-violet-500", accent: "bg-violet-600" },
];
