...
const products = [
  ...
  { key: "homeo", icon: "🌿", title: "Homeo Pro", subtitle: "होम्योपैथी क्लिनिक", descHi: "होम्योपैथी डॉक्टर के लिए — मरीज, दवा, prescription", descEn: "Homeopathy clinic — patients, medicines & prescriptions", exeUrl: "", pwaUrl: "#", software: "homeo", newPrice: "₹3,999", renewPrice: "₹1,499", accentText: "text-lime-400", accentBorder: "border-lime-500", accent: "bg-lime-500", comingSoon: true },
];
