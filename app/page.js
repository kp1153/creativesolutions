...
const products = [
  ...
  { key: "dental", icon: "🦷", title: "Dental Pro", subtitle: "Clinic Management", descHi: "डेंटल क्लिनिक के लिए — मरीज, prescription, treatment, billing", descEn: "Patients, Prescriptions, Treatments & Billing — all in one place", exeUrl: "", pwaUrl: DENTAL_PWA_URL, software: "dental", newPrice: "₹4,999", renewPrice: "₹1,999", accentText: "text-green-400", accentBorder: "border-green-500", accent: "bg-green-600" },
  ...
  { key: "pharma", icon: "💊", title: "Pharma Pro", subtitle: "दवा दुकान — Marg जैसा", descHi: "दवा की दुकान के लिए — stock, expiry, billing, GST", descEn: "Medicine stock, expiry alerts, billing & GST for pharmacies", exeUrl: "", pwaUrl: "#", software: "pharma", newPrice: "₹4,999", renewPrice: "₹1,999", accentText: "text-red-400", accentBorder: "border-red-500", accent: "bg-red-600" },
