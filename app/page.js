...
const hardwareFeatures = [
  {
    icon: "🧾",
    title: "बिलिंग",
    desc: "GST के साथ तुरंत बिल बनाओ — CGST, SGST automatic",
  },
  ...
  },
  {
    icon: "💸",
    title: "उधारी",
    desc: "किसने कितना लिया, कितना बाकी — WhatsApp reminder",
  },
...
const schoolFeatures = [
  {
    ...
    desc: "Admission, records, class & section — all in one place",
  },
  {
    icon: "✅",
    title: "Attendance",
    desc: "Daily attendance by class and date",
  },
  {
    icon: "💰",
    title: "Fee Management",
    desc: "Collect fees, print receipts, track pending payments",
  },
  {
    icon: "📝",
    title: "Exams & Results",
    desc: "Enter marks, auto grade, print report cards",
  },
  {
    icon: "👨‍👩‍👧",
    title: "Parent Portal",
    desc: "Parents can view fees, attendance & results anytime",
  },
  {
    icon: "📋",
    title: "Notice Board",
    desc: "Post announcements instantly — urgent notices highlighted",
  },
];
      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 text-white py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-xl mx-auto">
            हार्डवेयर की दुकान के लिए बना — बिल, स्टॉक, उधारी, GST रिपोर्ट सब एक
            जगह।
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-500 mb-10">
            Windows पर दुकान में चलाओ, Android पर राह चलते देखो
          </p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-2xl border-2 border-blue-600 p-8 shadow-lg">
              ...
              <p className="text-gray-500 text-sm mb-4">
                दुकान के computer पर install करो — internet बंद हो तो भी 72 घंटे
                काम करता है
              </p>
              ...
              <a
                href={HARDWARE_EXE_URL}
                className="block w-full bg-blue-600 text-white font-bold py-3 rounded-xl text-center hover:bg-blue-700 transition"
              >
                ⬇️ Download करें (.exe)
              </a>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border-2 border-blue-600 p-8 text-center shadow-lg relative">
              ...
              <a
                href="/payment?software=hardware"
      ...
      <section className="bg-gradient-to-br from-indigo-700 via-indigo-600 to-purple-700 text-white py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-indigo-100 mb-8 max-w-xl mx-auto">
            Built for CBSE private schools — Students, Fees, Attendance, Exams,
            Results & Parent Portal all in one place.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={SCHOOL_EXE_URL}
              className="inline-block bg-white text-indigo-700 font-bold text-lg px-8 py-4 rounded-2xl shadow-lg hover:bg-indigo-50 transition"
            >
              🖥️ Download for Windows (.exe)
            </a>
            <div className="flex flex-col items-center">
              <a
                href="https://school-saas-azure.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-green-500 text-white font-bold text-lg px-8 py-4 rounded-2xl shadow-lg hover:bg-green-600 transition"
              >
      ...
      <section className="py-12 px-4 bg-white text-center">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-gray-500 mb-6 text-sm">
            GST invoice तुरंत बनाओ — कोई signup नहीं, बिल्कुल मुफ्त
          </p>
          <a
